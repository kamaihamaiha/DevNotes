...
public class MediaSessionCompactDemoActivity extends BaseActivity {
    private MediaSessionCompactDemoService mDemoService;
    ...
    private void bindService(){
        bindService(new Intent(this, MediaSessionCompactDemoService.class),mConnection , Context.BIND_AUTO_CREATE);
    }
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
           mDemoService = ((MediaSessionCompactDemoService.MyBinder)service).getService();
